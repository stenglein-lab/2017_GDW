...
To get the dataset, we will use the fastq-dump tool, part of [SRA toolkit](https://www.ncbi.nlm.nih.gov/books/NBK158900/) 
...
Confirm that you downloaded the files.  You should see files named ERR1938563_1.fastq and one for the read pairs (_2.fastq)
